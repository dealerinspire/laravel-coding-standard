...
class SomeServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind('App\Contracts\Services\SomeOtherNameSpace\SomeOtherServiceContract', 'App\Services\SomeOtherNameSpace\SomeOtherService');
    ...
    public function provides(): array
    {
        return [
            ...
            'App\Contracts\Services\SomeOtherNameSpace\SomeOtherServiceContract',
